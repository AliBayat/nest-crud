...
let RMQMetadataAccessor = class RMQMetadataAccessor {
    ...
    getRMQTransformation(target) {
        return this.reflector.get(constants_1.RMQ_ROUTES_TRANSFORM, target);
    }
...
exports.RMQMetadataAccessor = RMQMetadataAccessor = __decorate([
