...
let RMQExplorer = class RMQExplorer {
    ...
    explore() {
        ...
        instanceWrappers.forEach((wrapper, i) => {
    ...
    attachEmitter(path, options, instance, methodRef) {
        router_emmiter_1.requestEmitter.on(path, (msg) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                let funcArgs = (options === null || options === void 0 ? void 0 : options.msgFactory) ? options.msgFactory(msg) : (0, exports.RMQMessageFactory)(msg);
    ...
    transformRequest(instance, methodRef, funcArgs) {
        ...
        funcArgs[0] = (0, class_transformer_1.plainToClass)(types[0], funcArgs[0]);
        return funcArgs;
    }
    validateRequest(instance, methodRef, funcArgs) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const errors = yield (0, class_validator_1.validate)(test);
            if (errors.length) {
...
exports.RMQExplorer = RMQExplorer = __decorate([
