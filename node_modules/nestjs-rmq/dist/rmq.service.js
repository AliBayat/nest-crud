...
let RMQService = class RMQService {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                const AMQPConnectionOptions = {
                    ...
                    connectionOptions: (_c = this.options.connectionOptions) !== null && _c !== void 0 ? _c : {},
                };
                ...
                this.server.on(constants_1.CONNECT_FAILED, (err) => {
                    this.logger.error(constants_1.CONNECT_FAILED_MESSAGE);
                    this.logger.error(err.err);
                    if (err.err.message.includes('ACCESS-REFUSED') || err.err.message.includes('403')) {
                        this.logger.error(constants_1.WRONG_CREDENTIALS_MESSAGE);
                        reject(err);
                    }
                });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                this.sendResponseEmitter.once(correlationId, (msg) => {
                    ...
                    if ((_b = (_a = msg.properties) === null || _a === void 0 ? void 0 : _a.headers) === null || _b === void 0 ? void 0 : _b['-x-error']) {
    ...
    createConnectionUri(connection) {
        var _a;
        let uri = `${(_a = connection.protocol) !== null && _a !== void 0 ? _a : constants_1.RMQ_PROTOCOL.AMQP}://${connection.login}:${connection.password}@${connection.host}`;
        if (connection.port) {
            uri += `:${connection.port}`;
        }
        if (connection.vhost) {
            ...
            return new Promise((resolve) => {
                this.subscriptionChannel = this.server.createChannel({
                    ...
                    setup: (channel) => __awaiter(this, void 0, void 0, function* () {
                        var _a, _b, _c;
                        yield channel.assertExchange(this.options.exchangeName, this.options.assertExchangeType ? this.options.assertExchangeType : 'topic', Object.assign({ durable: (_a = this.options.isExchangeDurable) !== null && _a !== void 0 ? _a : true }, this.options.exchangeOptions));
    ...
    listen(channel) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            const queue = yield channel.assertQueue(this.options.queueName, Object.assign({ durable: (_a = this.options.isQueueDurable) !== null && _a !== void 0 ? _a : true, arguments: (_b = this.options.queueArguments) !== null && _b !== void 0 ? _b : {} }, this.options.queueOptions));
            this.options.queueName = queue.queue;
            this.routes = this.metadataAccessor.getAllRMQPaths();
            if ((_c = this.options.autoBindingRoutes) !== null && _c !== void 0 ? _c : true) {
